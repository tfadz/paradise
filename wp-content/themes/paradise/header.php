			...
			<div class="container par-header__main">
				...
				<div class="row">
					<div>
						...
						$paradise_description = get_bloginfo( 'description', 'display' );
						if ( $paradise_description || is_customize_preview() ) :
							?>
							<p class="site-description"><?php echo $paradise_description; /* WPCS: xss ok. */ ?></p>
						<?php endif; ?>
					</div><!-- .site-branding -->
				</div>
